...
class SierpinskiTriangle(object):
    ...
    def get_mid_point_as_triangle(self):
        points = []
        points.append(self.get_mid_point(self.points[0], self.points[1]))
        points.append(self.get_mid_point(self.points[1], self.points[2]))
        points.append(self.get_mid_point(self.points[2], self.points[0]))
        return SierpinskiTriangle(points)
...
class DrawSierpinski(object):
    ...
    def get_sub_triangle(self, triangle, split_time, triangle_list):
        ...
        triangle_list.append(triangle.get_mid_point_as_triangle())
