...
public abstract class IBeerQueryServerStub extends RPCServerStub implements IBeerQueryS {
  public IBeerQueryServerStub() {
    super(IBeerQuery.class);
  }

  public RPCResponse dispatchCall(RPCCallInformation callInfo) throws RPCExceptionBase {
      ...
      case 1:
        {
          ...
          return callInfo.reply(retValue_);
        }
      case 2:
        {
